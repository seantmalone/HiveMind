...
WebsocketRails::EventMap.describe do
  ...
  subscribe :client_connected, :to => WsController, :with_method => :client_connected

  namespace :node do
    subscribe :register, :to => WsController, :with_method => :register
    subscribe :heartbeat, :to => WsController, :with_method => :heartbeat
  end

  namespace :block do
    subscribe :upload, :to => WsController, :with_method => :block_upload
  end
end
